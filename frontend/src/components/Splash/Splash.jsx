		...
		>
			...
			{login ? (
				<p className="splash__text txt--secondary">
					Get started by <span className="txt--fw-700">creating</span>{" "}
					an account or using your existing credentials to{" "}
					<span className="txt--fw-700">log in.</span>
				</p>
			) : (
				<p className="splash__text txt--secondary">
					Create a new invoice by clicking the{" "}
					<span className="txt--fw-700">New Invoice</span> button and
					get started
				</p>
			)}
